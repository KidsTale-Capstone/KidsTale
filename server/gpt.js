...
async function generateStory(keywords, genre, userId) {
    ...
    // 연령대별 문장 수 제한 설정
    if (age <= 10) {
        sentenceLimitPrompt = '이 동화는 영유아 및 초등학교 저학년을 위한 것으로, 분량은 10문장에서 20문장 이하로 작성해주세요. 내용에 적절하게 문단으로 나눠서 동화를 작성해주세요. 문체도 쉽고 친근하게 작성해주세요. 어려운 단어는 사용하지 말아주세요.';
    } else if (age >= 11 && age <= 13) {
        sentenceLimitPrompt = '이 동화는 초등학교 고학년을 위한 것으로, 분량은 20문장에서 30문장로 작성해주세요. 내용에 적절하게 문단으로 나눠서 동화를 작성해주세요. 문체는 적당하게 작성해주세요. 어려운 단어는 사용하지 말아주세요.';
    } else {
